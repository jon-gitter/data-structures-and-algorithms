...
const addOne = (arr) => {
  // Solution code here...
  let challengeOneArray = [];
  arr.forEach((element) => {
    challengeOneArray.push(element + 1);
  });
  return challengeOneArray;
}
...
const addExclamation = (arr) => {
  // Solution code here...
  let challengeTwoArray = [];
  arr.forEach((element) => {
    challengeTwoArray.push(element + '!');
  });
  return challengeTwoArray;
};
...
const allUpperCase = (arr) => {
  // Solution code here...
  let challengeThreeArray = [];
  arr.forEach(element => {
    challengeThreeArray.push(element.toUpperCase());
  });
  return challengeThreeArray;
};
...
const greeting = (word) => {
  // Solution code here...
  let upperArray = word.toUpperCase() + '!'
  return upperArray;
};
...
const speaker = (words, callback) => {
  ...
  let speakArray = [];
  words.forEach(str => {
    speakArray.push(str.toUpperCase() + '!');
  });
  return speakArray;
};
